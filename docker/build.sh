...
OPTIONS:
    --platform PLATFORM    Platform to build: cuda, ascend, hygon, metax, musa, musa (default: ${PLATFORM})
...
EXAMPLES:
    ...
    # Build Moore Threads MUSA CI image
    ./build.sh --platform musa --target ci --image-name harbor.baai.ac.cn/flagos-dev/vllm-plugin-fl
...
if [[ "${PLATFORM}" == "cuda" ]]; then
    ...
    BUILD_ARGS+=(
        ...
        --build-arg "PYTHON_VERSION=${MUSA_PYTHON_VERSION}"
